...
The assembler binary along with the compiled test binaries will be saved on `out/bin`
Simulation files generated by [iverilog](https://github.com/steveicarus/iverilog) will be saved on `out/`
